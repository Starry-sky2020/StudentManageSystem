    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="<%=request.getContextPath()%>/list/userList.jsp" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    <a href="<%=request.getContextPath()%>/list/index.html" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>首页</a>
                    <a href="<%=request.getContextPath()%>/list/userList.jsp" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>管理员工</a>
                    <a href="<%=request.getContextPath()%>/stulist" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>管理学生</a>
                    <a href="<%=request.getContextPath()%>/list/createManager.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>添加管理员</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="userList.jsp" class="navbar-brand d-flex d-lg-none me-4">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="<%=request.getContextPath()%>/list/img/user.jpg" alt="" style="width: 40px; height: 40px;">
...
<%--                                    <th scope="col"><input class="form-check-input" type="checkbox"></th>--%>
                            ...
                            <tbody>
                                <c:forEach items="${users}" var="user">
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-danger m-2" onclick="delUser(${user.user_id})
                                            ">删除</button></td>
                                    </tr>
                                </c:forEach>
    ...
    <script src="/<%=request.getContextPath()%>/list/lib/chart/chart.min.js"></script>
